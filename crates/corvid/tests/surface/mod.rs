...
static MANIFEST: &[Row] = &[
    ...
    row(
        ...
        "Lifecycle",
        &[
            "lifecycle_cuckoo_filter_membership_delete_and_bounded_fp",
            "lifecycle_cuckoo_filter_overflow_rejects_and_rollback_preserves_admitted",
        ],
    ),
    row(
        "corvid::CuckooFilter::new",
        "Lifecycle",
        &[
            "lifecycle_cuckoo_filter_membership_delete_and_bounded_fp",
            "lifecycle_cuckoo_filter_overflow_rejects_and_rollback_preserves_admitted",
    ...
    row(
        "corvid::CuckooFilter::contains_bytes",
        "Lifecycle",
        &[
            "lifecycle_cuckoo_filter_membership_delete_and_bounded_fp",
            "lifecycle_cuckoo_filter_overflow_rejects_and_rollback_preserves_admitted",
    ...
    row(
        "corvid::CuckooFilter::delete_bytes",
        "Lifecycle",
        &["lifecycle_cuckoo_filter_membership_delete_and_bounded_fp"],
    ),
    row(
        ...
        "Lifecycle",
        &[
            "lifecycle_tdigest_exact_boundaries_nan_and_monotone_cdf",
            "lifecycle_tdigest_merge_algebra_and_bounded_error",
        ],
    ),
    row(
        "corvid::TDigest::new",
    ...
    row(
        "corvid::TDigest::merge",
        "Lifecycle",
        &["lifecycle_tdigest_merge_algebra_and_bounded_error"],
    ),
    row(
        "corvid::TDigest::quantile",
        "Lifecycle",
        &[
            "lifecycle_tdigest_exact_boundaries_nan_and_monotone_cdf",
            "lifecycle_tdigest_merge_algebra_and_bounded_error",
    ...
    row(
        "corvid::MinHash",
        "Lifecycle",
        &["lifecycle_minhash_signature_invariance_and_jaccard_bounds"],
    ),
    row(
        "corvid::MinHash::new",
        "Lifecycle",
    ...
    row(
        "corvid::MinHash::signature",
        "Lifecycle",
        &["lifecycle_minhash_signature_invariance_and_jaccard_bounds"],
    ),
    row(
        "corvid::MinHash::jaccard_estimate",
        "Lifecycle",
        &["lifecycle_minhash_signature_invariance_and_jaccard_bounds"],
    ),
    row(
        "corvid::LshIndex",
        "Lifecycle",
        &["lifecycle_lsh_banding_recall_and_skew_fixed_corpus"],
    ),
    row(
        "corvid::LshIndex::new",
        "Lifecycle",
    ...
    row(
        "corvid::LshIndex::insert",
        "Lifecycle",
        &["lifecycle_lsh_banding_recall_and_skew_fixed_corpus"],
    ),
    row(
        "corvid::LshIndex::candidates",
        "Lifecycle",
        &["lifecycle_lsh_banding_recall_and_skew_fixed_corpus"],
    ),
    row(
